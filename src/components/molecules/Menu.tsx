...
const Menu = forwardRef(({ options }: MenuProps, ref) => {
    ...
    return <div ref={menuRef} className='menu shadow-menu bg-white dark:bg-neutral-800 rounded-xl p-2 absolute top-full right-0'>{menu}</div>;
})
