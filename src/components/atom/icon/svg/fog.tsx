...
const Fog = ({ size = 12, className }: IconProps) => {
    return (
        ...
        >
            ...
            <g filter="url(#filter1_bi_19_345)">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
            ...
            <defs>
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="11"
                        result="effect1_foregroundBlur_19_345"
                    />
                </filter>
                <filter
                    id="filter1_bi_19_345"
                    x="-7"
                    y="-7"
                    width="122"
                    height="80"
                ...
                >
                    ...
                    <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_19_345"
                    />
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_backgroundBlur_19_345"
                        result="shape"
                    />
                    <feColorMatrix
                        in="SourceAlpha"
                    ...
                    <feBlend
                        mode="normal"
                        in2="shape"
                        result="effect2_innerShadow_19_345"
                    />
                </filter>
                <linearGradient
                    id="paint0_linear_19_345"
                    x1="56"
                    y1="89.5"
                    x2="96.5"
                    y2="1.95655e-07"
