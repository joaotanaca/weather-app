...
//3
const Cloudy = ({ size = 12, className }: IconProps) => {
    return (
        <svg
            className={className}
            width={size}
            ...
            <defs>
                ...
                >
                    ...
                    <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_1_535"
                    />
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_backgroundBlur_1_535"
                        result="shape"
                    />
                    <feColorMatrix
                        in="SourceAlpha"
                    ...
                    <feBlend
                        mode="normal"
                        in2="shape"
                        result="effect2_innerShadow_1_535"
                    />
                </filter>
                <filter
                    id="filter1_f_1_535"
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="11"
                        result="effect1_foregroundBlur_1_535"
                    />
                </filter>
                <filter
                    id="filter2_bi_1_535"
