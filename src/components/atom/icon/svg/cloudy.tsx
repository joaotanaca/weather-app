...
const Cloudy = ({ size = 12, className }: IconProps) => {
    return (
        ...
        >
            <g filter="url(#filter0_f_7_10945)">
                <g filter="url(#filter1_d_7_10945)">
                    <path
                        ...
                        fill="url(#paint0_linear_7_10945)"
                    />
                    <path
            ...
            <defs>
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="2"
                        result="effect1_foregroundBlur_7_10945"
                    />
                </filter>
                <filter
                    id="filter1_d_7_10945"
                    x="0"
                    y="0"
                    width="413.345"
                    height="281"
                ...
                >
                    ...
                    <feBlend
                        mode="normal"
                        in2="BackgroundImageFix"
                        result="effect1_dropShadow_7_10945"
                    />
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_7_10945"
                        result="shape"
                    />
                </filter>
                <linearGradient
                    id="paint0_linear_7_10945"
                    x1="196.698"
                    y1="28.0024"
                    x2="299.341"
                    y2="276.166"
