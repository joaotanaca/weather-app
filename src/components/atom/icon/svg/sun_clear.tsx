  ...
  return (
    ...
    >
      <g filter="url(#filter0_ddi_1_771)">
        <circle cx="55" cy="55" r="32" fill="url(#paint0_linear_1_771)" />
      </g>
      <defs>
        <filter
        ...
        >
          ...
          <feBlend mode="normal" in2="shape" result="effect3_innerShadow_1_771" />
        </filter>
        <linearGradient id="paint0_linear_1_771" x1="55" y1="23" x2="55" y2="87" gradientUnits="userSpaceOnUse">
