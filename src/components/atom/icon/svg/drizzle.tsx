...
const Drizzle = ({ size = 12, className }: IconProps) => {
    return (
        ...
        >
            <g filter="url(#filter0_f_7_11162)">
                <path
                ...
                />
                <path
                    d="M120.36 269.884C124.718 271.217 130.256 265.736 132.731 257.642C135.205 249.549 133.678 241.908 129.321 240.575C124.963 239.243 119.424 244.724 116.95 252.817C114.475 260.911 116.002 268.552 120.36 269.884Z"
                    fill="white"
                />
                <path
                    d="M256.359 249.207C258.824 249.236 283.839 288.291 283.839 303.468C283.795 310.728 280.881 317.675 275.732 322.793C270.583 327.911 263.618 330.783 256.359 330.783C249.099 330.783 242.134 327.911 236.985 322.793C231.836 317.675 228.922 310.728 228.878 303.468C228.878 288.291 253.893 249.18 256.359 249.207Z"
                    fill="#42A0F0"
                />
                <path
                    ...
                    fill="white"
                />
                <g filter="url(#filter1_d_7_11162)">
                    <path
                        ...
                        fill="url(#paint0_linear_7_11162)"
                    />
                    <path
            ...
            <defs>
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="2"
                        result="effect1_foregroundBlur_7_11162"
                    />
                </filter>
                <filter
                    id="filter1_d_7_11162"
                    x="0"
                    y="0"
                    width="413.345"
                    height="281"
                ...
                >
                    ...
                    <feBlend
                        mode="normal"
                        in2="BackgroundImageFix"
                        result="effect1_dropShadow_7_11162"
                    />
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_7_11162"
                        result="shape"
                    />
                </filter>
                <linearGradient
                    id="paint0_linear_7_11162"
                    x1="196.698"
                    y1="28.0024"
                    x2="299.341"
                    y2="276.166"
